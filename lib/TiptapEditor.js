...
export class TiptapEditor {
    ...
    injectStyles() {
        ...
        style.innerHTML = `
            .editor-container {
                ...
                max-width: 1100px;
                margin: 8px auto;
                background: var(--editor-bg-color, white);
                border-radius: 20px;
            ...
            .editor-container.dark { background: var(--editor-bg-color, #1e293b); border-color: #334155; box-shadow: 0 10px 40px -10px rgba(0, 0, 0, 0.3); }
            ...
            .slash-menu {
                ...
                box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); padding: 8px; width: 220px;
            ...
            .slash-menu::-webkit-scrollbar-thumb { background: #e2e8f0; border-radius: 10px; }
            .dark .slash-menu::-webkit-scrollbar-thumb { background: #475569; }
    ...
    applyPrefs(prefs) {
        ...
        if (prefs.fontFamily) root.style.setProperty('--body-font-family', prefs.fontFamily);
        if (prefs.bodySize) root.style.setProperty('--body-font-size', prefs.bodySize);
        if (prefs.lineHeight) root.style.setProperty('--line-height', prefs.lineHeight);
        if (prefs.h1Size) root.style.setProperty('--heading-size-h1', prefs.h1Size);
        if (prefs.h2Size) root.style.setProperty('--heading-size-h2', prefs.h2Size);
        if (prefs.paraSpacing) root.style.setProperty('--paragraph-spacing', prefs.paraSpacing);
        if (prefs.bgColor) root.style.setProperty('--editor-bg-color', prefs.bgColor);
    }
